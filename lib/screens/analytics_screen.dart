...
class _ExerciseListScreenState extends State<ExerciseListScreen> {
  ...
  List<Map<String, dynamic>> _getExercisesForCategory(String category) {
    // (Contenido de ejercicios se mantiene en EN — puedes traducirlos luego si quieres)
    switch (category) {
    // ... (tu lista de ejercicios A, B y C tal cual)
    // NO modifiqué el contenido para no alargar: deja las descripciones igual.
      default:
        return [];
    }
  }
