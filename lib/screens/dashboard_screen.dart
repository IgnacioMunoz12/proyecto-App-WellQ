...
class _DashboardScreenState extends State<DashboardScreen> with WidgetsBindingObserver {
  ...
  // ====== NUEVO: diálogo para actualizar el peso ======
        ...
        child: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              // (eliminada) Card de Ritmo Cardíaco grande
                  ...
                  children: [
                    ...
                    _GridCards(children: [
                      ...
                      _MetricRingCard(
                        ...
                        valueText:
                        (healthService.sleepProgress * 100).clamp(0, 100).round().toString(),
